...
{
	ifstream inFile;
	double priceOfBoxTicket, priceOfSidelineTicket, priceOfPremiumTicket,
		   priceOfGenAdmissionTicket;

	int numOfBoxTicketSold, numOfSidelineTicketSold, numOfPremiumTicketSold,
		numOfGenAdmissionTicketSold, totalNumOfTicketsSold;

	double amtOfBoxTicketSold, amtOfSidelineTicketSold, amtOfPremiumTicketSold,
		   amtOfGenAdmissionTicketSold, totalSaleAmount;
